...
const FACTIONS: Array<{ id: FactionId | 'DIRECTOR'; label: string; desc: string; warCry: string; color: string; textColor: string }> = [
  ...
  { id: 'BRICS',    label: 'BRICS Coalition',   desc: 'Activate yuan oil clearing. Pull Saudi + India in.',          warCry: 'The old order ends this week.',                  color: 'border-yellow-500', textColor: '#facc15' },
