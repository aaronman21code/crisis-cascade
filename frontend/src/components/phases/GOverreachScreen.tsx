            ...
            <AnimatePresence>
              {submittedAction && (
                <motion.div
                  ...
                  style={{ borderColor: `${factionColor}40`, backgroundColor: `${factionColor}08` }}
                >
                  <div className="text-xs font-mono text-gray-500 uppercase tracking-widest mb-1">Action locked</div>
                  ...
                  <div className="mt-3 text-xs text-gray-600">
                    Waiting for others... {actionsProgress.submitted}/{actionsProgress.total} submitted
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
